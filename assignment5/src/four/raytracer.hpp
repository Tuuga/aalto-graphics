...
struct RaySegment {
	RaySegment(FW::Vec3f origin, FW::Vec3f offset, FW::Vec3f normal_at_offset) : origin(origin), offset(offset), normal_at_offset(normal_at_offset) {}
	FW::Vec3f origin, offset, normal_at_offset;
};
